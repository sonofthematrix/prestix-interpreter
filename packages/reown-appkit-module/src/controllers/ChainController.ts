...
import { AdapterController } from './AdapterController/index'
import { ConnectionController, type ConnectionControllerClient } from './ConnectionController'
  ...
  async switchActiveNetwork(
    ...
    try {
      ...
      if (
        ...
        // ChainAdapter doesn't have switchNetwork method - network switching is handled differently
        // The network switch is handled by the connection controller client or adapter-specific logic
